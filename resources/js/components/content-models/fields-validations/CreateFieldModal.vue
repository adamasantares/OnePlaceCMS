                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" v-model="fields.list"
                                                           :class="errors && errors.list ? 'is-invalid' : ''"
                                                           id="list-check">
                                                    <label class="form-check-label" for="list-check">
                                                        List
                                                    </label>
                                                    <div v-if="errors && errors.list" class="invalid-feedback">{{ errors.list[0] }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
