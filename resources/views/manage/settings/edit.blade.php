            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select id="slider-on-main" class="form-control" name="settings[slider-on-main]">
                        @include('manage.settings.partials.sliders', ['sliders' => $sliders, 'selectedItems' => $settings['slider-on-main'] ?? []])
                    </select>
                </div>
                <div class="form-group">
                    <label for="links-on-main">Ссылки на главной</label>
                    <select id="links-on-main" class="form-control" name="settings[links-on-main]">
                        @include('manage.settings.partials.sliders', ['sliders' => $sliders, 'selectedItems' => $settings['links-on-main'] ?? []])
                    </select>
                </div>
                <div class="form-group">
                    <label for="banner-on-main">Баннер на главной</label>
                    <select id="banner-on-main" class="form-control" name="settings[banner-on-main]">
                        @include('manage.settings.partials.sliders', ['sliders' => $sliders, 'selectedItems' => $settings['banner-on-main'] ?? []])
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="categories-on-main" class="form-control" name="settings[categories-on-main][]" multiple>
                        @include('manage.settings.partials.categories', ['categories' => $categories, 'selectedItems' => $settings['categories-on-main'] ?? []])
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="reviews-on-main" class="form-control" name="settings[reviews-on-main]">
                        @include('manage.settings.partials.sliders', ['sliders' => $sliders, 'selectedItems' => $settings['reviews-on-main'] ?? []])
                    </select>
                </div>
                <div class="form-group">
                    <label for="reviews-on-main">Главное меню</label>
                    <select id="reviews-on-main" class="form-control" name="settings[main-menu]">
                        @include('manage.settings.partials.menus', ['menus' => $menus, 'selectedItems' => $settings['main-menu'] ?? []])
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select id="reviews-on-main" class="form-control" name="settings[sidebar-dokumenty]">
                        @include('manage.settings.partials.menus', ['menus' => $menus, 'selectedItems' => $settings['sidebar-dokumenty'] ?? []])
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select id="reviews-on-main" class="form-control" name="settings[sidebar-meditsinskoe-oborudovanie]">
                        @include('manage.settings.partials.menus', ['menus' => $menus, 'selectedItems' => $settings['sidebar-meditsinskoe-oborudovanie'] ?? []])
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select id="categories-on-main" class="form-control" name="settings[sidebar-reports]">
                        @include('manage.settings.partials.category', ['categories' => $categories, 'selectedItem' => $settings['sidebar-reports'] ?? []])
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select id="reviews-on-main" class="form-control" name="settings[sidebar-uslugu]">
                        @include('manage.settings.partials.menus', ['menus' => $menus, 'selectedItems' => $settings['sidebar-uslugu'] ?? []])
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select id="reviews-on-main" class="form-control" name="settings[sidebar-uslugu-roszdrav]">
                        @include('manage.settings.partials.menus', ['menus' => $menus, 'selectedItems' => $settings['sidebar-uslugu-roszdrav'] ?? []])
                    </select>
                </div>
            </div>
