    ...
    <div class="card-body">
        <div class="tab-content">
            <div class="tab-pane active show" id="slider">
                @include('content-manage.sliders.partials.form')
                <hr>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div id="accordion">
                    @forelse($sliderItems as $index => $sliderItem)
                        @php
                            $counter = $index + 1;
                        @endphp
                        @include('content-manage.sliders.partials.slide_item')
                    @empty
                    @endforelse
                </div>

                @include('content-manage.sliders.partials.slide_script_item')
            </div>
            <!-- /.tab-pane -->
            <div class="tab-pane" id="media">
                @include('content-manage.sliders.partials.media')
            </div>
            <!-- /.tab-pane -->
        </div>
    </div>
